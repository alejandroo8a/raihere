...
public class chofer extends Fragment {
    private static String TAG = "chofer";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_chofer, container, false);
        //OBTENEMOS EL RECYCLER
        recycler = (RecyclerView) view.findViewById(R.id.chofer_recycler);
        mensaje=(TextView)view.findViewById(R.id.txtnochofer);
        progressView=(ProgressView)view.findViewById(R.id.progreschofer);
    ...
    public void onActivityCreated(Bundle state) {
        ...
        peticiones.chofer_pasajero(getContext(),sharedPreferences.getString("IDUSUARIO","1"),"chofer_historial");
